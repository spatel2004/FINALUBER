...
public class CityMap
{
  ...
  public static int getCityZone(String address) {
    ...
    int [] city_block = getCityBlock(address);

    // assigns zone numbers based on city block street and avenue numbers 
    if ((city_block[0] >= 6 && city_block[0] <= 9) && (city_block[1] >= 1 && city_block[1] <= 5)) {
      return 0;
    }
    else if ((city_block[0] >= 6 && city_block[0] <= 9) && (city_block[1] >= 6 && city_block[1] <= 9)) {
      return 1;
    }
    else if ((city_block[0] >= 1 && city_block[0] <= 5) && ( city_block[1] >= 6 && city_block[1] <= 9)) {
      return 2;
    }
    else if ((city_block[0] >= 1 && city_block[0] <= 5) && (city_block[1] >= 1 && city_block[1] <= 5)) {
      return 3;
    }
    return -1;
  }
